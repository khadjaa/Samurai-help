/*
Complete the function word (string) and returns
a string that spells the word using the NATO phonetic alphabet.

There should be a space between each word in the
returned string, and the first letter of each word should be capitalized.
...
const nato = (function() {
    ...
    return function(word) {
        ...
        let lettersArray = upperCaseWord.split('');
        let natoWords = lettersArray.map(letter => letters[letter]);
